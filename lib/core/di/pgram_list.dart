...
List<Program> p = const [
  ...
  Program(
    ...
    mainTitle: "Therapeutic Yoga Sessions",
    // subTitle: "",
    id: "therapeutic",
  ),
  Program(
  ...
  Program(
    ...
    description:
        'Meditation Meditation is an art to master the self with various techniques to sublimate any types of disturbances and from any distractions of the mind, Classes periodically conducted, register with the centre to know more about the program schedules.  \nPranayama \nSpecial classes to master the art of energising techniques and experience life with high energy levels throughout life. \nVarious breathing practices conducted to suit one and all. Register with the centre to know more about the program schedules.',

    mainTitle: "Meditation Pranayama",
    // subTitle: "",
    id: "PERSONAL SESSION YOGAA",
  ),
];
