...
@LazySingleton(as: IGetVoiceOfSky)
class GetVoiceOfSkyRepository implements IGetVoiceOfSky {
  @override
  Future<Either<MainFailure, VoiceData>> getVoiceofSky() async {
    var dio = Dio();
    ...
    try {
      final response = await dio.get(
          "https://gurujisanjeevkrishna.com/api/get-voice-of-sky",
